...
define(function (require) {
    ...
    ret.getGridData = function () {
        ...
        return [
            { Id: 11, aaaa: '最高权限', bbbb: '10', cccc: '所有数据', dddd: '机密', eeee: '增删改查' },
            { Id: 12, aaaa: '一般权限', bbbb: '120', cccc: '所有数据', dddd: '机密', eeee: '增删改查' },
            { Id: 13, aaaa: '访客权限', bbbb: '9999', cccc: '所有数据', dddd: '机密', eeee: '增删改查' }
