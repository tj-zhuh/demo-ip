...
define(function (require) {
    ...
    function showWin1() {
        ...
        var win2 = window.parent.document.getElementById('win2');

        $(win2).removeClass('hide');
        $(mo).removeClass('hide');
        ...
        ret.tb.config({
            ...
            columns: [{
                ...
                renderer: function (line) {
                    if (line.qqqq) {
                        return "<a id='guzhang' style='text-decoration:underline;color:#00deb9;font-size:0.14rem;'>" + line.qqqq + "</a>";
                    }
                    else {
                        return '&nbsp;'
                    }
