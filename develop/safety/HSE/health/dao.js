...
define(function (require) {
    ...
    ret.getGrid1Data = function () {
    	...
    	var prop = ['Id'];
    	var data = [
            ['01', '危险化学品安全管理条例', '国家法规', '2007-03-12', '李良', '', '查看详细信息'],
            ['02', '特种设备安全检查条例', '国家法规', '2007-04-03', '李良', '', '查看详细信息'],
            ['03', '安全生产许可证条例', '国家法规', '2007-06-17', '李良', '', '查看详细信息'],
            ['04', '使用有毒物品作业场所劳动保护条例', '国家法规', '2008-07-12', '李良', '', '查看详细信息'],
		];
