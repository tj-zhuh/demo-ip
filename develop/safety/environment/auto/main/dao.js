...
define(function (require) {
    ...
    ret.getGrid1Data = function () {
    	...
    	var prop = ['Id'];
    	var data = [
            ['2008-11-04 11:20:00', '原油-油罐-监控项目-压力-已达到二级预警', '好油罐', '压力', '二级'],
            ['2008-12-01 14:20:00', '原油-油罐-监控项目-压力-已达到二级预警', '好油罐', '压力', '二级'],
            ['2008-12-07 17:20:00', '原油-油罐-监控项目-温度-已达到二级预警', '好油罐', '温度', '二级'],
            ['2009-01-05 19:20:00', '原油-油罐-监控项目-温度-已达到二级预警', '好油罐', '温度', '二级'],
            ['2008-02-21 23:20:00', '原油-油罐-监控项目-压力-已达到二级预警', '好油罐', '压力', '二级'],
		];
